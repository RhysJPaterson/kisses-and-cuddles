...
pygame.display.set_caption('Kisses and Cuddles - Made By Rhys Paterson')
surface = pygame.image.load('Icon.ico')
...
def draw_vertical_winning_line(col, player):
  ...
  if player == 1:
    ...
    OWinMessage(messagebox)
  elif player == 2:
    color = CROSS_COLOR
    pygame.draw.line(screen, color, (posX, 15), (posX, HEIGHT - 15), LINE_WIDTH)
    XWinMessage(messagebox)
...
def XWinMessage(messagebox):
  root = tkinter.Tk()
  root.withdraw()

  messagebox.showinfo("Winner", "X Wins, Click R To Restart Game")


def OWinMessage(messagebox):
  root = tkinter.Tk()
  root.withdraw()

  messagebox.showinfo("Winner", "O Wins, Click R To Restart Game")

def Draw(messagebox):
  root = tkinter.Tk()
  root.withdraw()

  messagebox.showinfo("Draw", "This Game Is A Draw, Click R To Restart Game")
